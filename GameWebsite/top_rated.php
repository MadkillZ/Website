...
?>
	...
	var counter = 1;
		...
		var htmlString = "";
		$.get("https://api.rawg.io/api/games?page_size=30&page=1&metacritic=80,100&key=7da2ce5bfa5d4c0dbc6e02d906b9387a&20", function(data, status){
			for(var i=1;i<=20;i++){
				...
				var htmlString = "";
				$.get("https://api.rawg.io/api/games?page_size=30&ordering=-metacritic&metacritic=80,100&page="+ counter +"&key=7da2ce5bfa5d4c0dbc6e02d906b9387a&20", function(data, status){
					for(var i=1;i<=20;i++){
						var id = data.results[i].id;
						$.get("https://api.rawg.io/api/games/" + id + "?key=7da2ce5bfa5d4c0dbc6e02d906b9387a&20", function(data2, status){
								//console.log("Data: " + data2.name + "\nStatus: " + status);
